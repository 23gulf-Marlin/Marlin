...
#define STRING_CONFIG_H_AUTHOR "(10/05/22 Artillery SX1, SKR3 EZ bugfix 2.1.x )" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Artillery SX1"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  17.4  } 
    #define DEFAULT_Ki_LIST {   1.12 }
    #define DEFAULT_Kd_LIST {  67.9  }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 15.9
  #define DEFAULT_bedKi 2.58
  #define DEFAULT_bedKd 65.3
...
#define THERMAL_PROTECTION_HOTENDS // Enable thermal protection for all extruders Caution WR
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 820.9 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {33, -40, -2.722 } // 23 Gulf WR
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 40, 50, 70, 40 } // (mm) Left, Front, Right, Back insets
