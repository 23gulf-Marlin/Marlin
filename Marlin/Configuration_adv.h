...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
  #define Z_STEPPER_ALIGN_XY { {  35, 165 }, { 260, 165 } }  // 23 Gulf WR
   ...
   * driver order.
   */
  //#define Z_STEPPER_ALIGN_STEPPER_XY { { 20, 155 }, { 260, 155 } }
  ...
  #define Z_STEPPER_ALIGN_ACC        0.025 // Stop iterating early if the accuracy is better than this
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  40, 60 }, { 260,  60 }, { 260, 255}, { 40, 255 } }
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1 // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu  // 23 Gulf WR
